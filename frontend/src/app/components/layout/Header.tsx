...
export function Header() {
  ...
  return (
    <header className="h-16 flex items-center gap-4 px-4 lg:px-6 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 sticky top-0 z-30 flex-shrink-0">
      {/* Mobile menu */}
      <button
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            ...
            {unreadCount > 0 && (
              <span className="absolute -top-0.5 -right-0.5 min-w-[16px] h-4 flex items-center justify-center bg-indigo-500 text-white text-[9px] font-bold rounded-full px-0.5">
                ...
                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-gray-800">
                  <p className="text-sm font-semibold text-gray-800 dark:text-gray-200">
                    Notificações {unreadCount > 0 && (
                      <span className="ml-1.5 px-1.5 py-0.5 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 text-xs rounded-full">{unreadCount}</span>
                    )}
                  </p>
                  {unreadCount > 0 && (
                    <button
                    ...
                    notifications.map((n) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {n.content && (
                            <p className="text-xs text-gray-500 mt-0.5 leading-snug line-clamp-2">{n.content}</p>
                          )}
