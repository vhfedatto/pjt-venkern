        ...
        <div className="w-full max-w-sm space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1.5">
              ...
              <Input id="name" type="text" autoComplete="name" placeholder="Seu Nome" value={name} onChange={e => handleNameChange(e.target.value)} required disabled={loading} />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input id="username" type="text" autoComplete="username" placeholder="seunome" value={username} onChange={e => {
                setUsername(slugify(e.target.value));
                setUsernameEdited(true);
              }} disabled={loading} className="pl-7" />
              </div>
              {username && <p className="text-xs text-indigo-600 font-medium">Seu identificador: @{username}</p>}
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <PasswordInput id="password" autoComplete="new-password" placeholder="Mínimo 6 caracteres" value={password} onChange={e => setPassword(e.target.value)} required disabled={loading} />
            </div>

            <div className="space-y-1.5">
              <Label htmlFor="confirm">Confirmar senha</Label>
              <PasswordInput id="confirm" autoComplete="new-password" placeholder="Repita a senha" value={confirm} onChange={e => setConfirm(e.target.value)} required disabled={loading} />
            </div>
