        ...
        <div className="lg:col-span-1">
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
            ...
            <div className="p-5 border-b border-gray-100 dark:border-gray-800 text-center">
              ...
              {team && (
                <span className={`inline-block mt-2 text-xs px-2 py-0.5 rounded-full ${team.bgColor} ${team.textColor} font-medium`}>
                  {team.name}
                </span>
              )}
            </div>
              ...
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input type="email" value={profileForm.email} onChange={e => setProfileForm(p => ({ ...p, email: e.target.value }))} className={inputCls} />
                  </div>
                  <div>
                    <label className={labelCls}>Cargo</label>
                    <input type="text" value={profileForm.position} onChange={e => setProfileForm(p => ({ ...p, position: e.target.value }))} className={inputCls} />
                  </div>
                </div>
            ...
            {activeSection === 'notificacoes' && (
              <div className="space-y-5">
                ...
                {[
                  ...
                  { label: 'Alertas de moderação', sublabel: 'Só visível para admins', defaultChecked: currentUser.role === 'admin' },
                  { label: 'Novos membros na equipe', sublabel: 'Quando alguém entra na equipe', defaultChecked: false },
                ].map(({ label, sublabel, defaultChecked }) => (
